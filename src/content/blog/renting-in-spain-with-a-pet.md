---
title: "Renting in Spain With a Pet: Getting a Yes"
excerpt: "A landlord can legally refuse your pet in Spain, but only if it's written into the contract — and only if you let the pet be a surprise instead of a plan."
category: "Guides"
minutes: 7
pubDate: 2026-08-13
...
faq:
  ...
  - q: "What if my rental contract in Spain doesn't mention pets?"
    a: "Silence protects you. A landlord can't add a pet ban after you've signed, and can't use a pet as grounds for non-renewal unless another legitimate reason exists — one of the few places a contract's silence works in the tenant's favor."
  - q: "What happens if I get a pet when my contract bans them?"
    a: "It's a real breach, not a gray area — the same consequences as any other contract violation. The landlord can demand the pet be removed, and if you refuse, start legal proceedings to terminate the lease. No damage has to occur; having the pet is the breach."
  - q: "Can a building ban my pet even if my landlord allows it?"
    a: "A building's community statutes can restrict shared spaces — mandatory leashes, muzzles for certain breeds in common areas — but they can't force your individual landlord to ban your pet. The two are separate layers of rules."
  - q: "Where can I search for pet-friendly rentals in Spain?"
    a: "Idealista, Fotocasa, Zazume, and Rentola all have a pets-allowed filter, which narrows the search to places where nobody needs convincing. It reduces the available inventory, especially in high-demand cities, but saves time for a harder-to-place pet."
---
...
- [Can a landlord in Spain say no to your pet?](#can-a-landlord-in-spain-say-no-to-your-pet)
- [What happens if you already have a pet](#what-happens-if-you-already-have-a-pet)
- [Building rules vs. your landlord's rules](#building-rules-vs-your-landlords-rules)
- [How to present your pet so the answer is yes](#how-to-present-your-pet-so-the-answer-is-yes)
- [Being honest: some pets are just harder to place](#being-honest-some-pets-are-just-harder-to-place)
- [Where to search if you want a head start](#where-to-search-if-you-want-a-head-start)
...
When I call a listing on a reader's behalf, the pet is part of the profile from the first conversation — not something that surfaces mid-process and costs trust right when it matters most. [Bring it up at the viewing too, not just the first call](/blog/how-to-prepare-for-a-rental-viewing-in-spain/) — one more moment where a surprise costs more than a plan.
