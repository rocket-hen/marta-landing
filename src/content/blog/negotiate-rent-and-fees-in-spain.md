---
title: "How to Negotiate Rent and Fees in Spain"
excerpt: "What actually gets a landlord to move on price, and which fees a landlord or agency legally can't charge you — one of them almost certainly doesn't apply."
category: "Guides"
minutes: 8
pubDate: 2026-08-13
...
faq:
  ...
  - q: "Who pays agency fees in Spain, the landlord or the tenant?"
    a: "The landlord, for a primary residence, since Ley 12/2023. Real estate management and contract-formalization fees can't legally be charged to the tenant on a standard residential lease — only temporada (seasonal) and commercial contracts fall outside this rule."
  - q: "What is the solvency study fee in Spain?"
    a: "A renamed version of the agency fee the 2023 law banned — same charge, different label, sometimes called 'estudio de solvencia' or 'legal advisory.' It's still illegal to charge a tenant on a primary-residence contract, whatever it's called on the invoice."
  - q: "How do I ask a landlord to lower the rent?"
    a: "Trade a real commitment for it instead of just asking — offering a full year instead of a short lease, all payments on direct debit, or the first month transferred at signing. \"Can you lower it?\" rarely works on its own; a concrete reason to say yes usually does."
  - q: "What should I do if an agency tries to charge me a fee?"
    a: "Decline and name the law directly — Ley 12/2023. Ask for a written breakdown of any charges before signing anything. If the agency insists, a complaint can be filed with the regional consumer affairs office (oficina de consumo)."
---
...
- [When there's real room to negotiate the rent](#when-theres-real-room-to-negotiate-the-rent)
- [How to ask without it sounding like haggling](#how-to-ask-without-it-sounding-like-haggling)
- [When negotiating backfires](#when-negotiating-backfires)
- [The fee most expats pay by mistake](#the-fee-most-expats-pay-by-mistake)
- [The renaming trick agencies use](#the-renaming-trick-agencies-use)
- [The real exceptions](#the-real-exceptions)
- [What to do if an agency pushes back](#what-to-do-if-an-agency-pushes-back)
...
Knowing what's negotiable and what's illegal to charge protects the money side of this. It doesn't get you to the front of the line for a listing worth negotiating over in the first place — that's a speed problem, not a knowledge one, and it's the one [I actually solve by getting an agent on the phone](/blog/how-to-rent-an-apartment-in-spain-as-an-expat/) before someone else does. Once you know the number you're working with, [here's what the rest of that number should actually cover](/blog/how-much-money-do-you-need-to-rent-in-spain/) — and [what to check before you say yes at a viewing](/blog/how-to-prepare-for-a-rental-viewing-in-spain/).
