...
faq:
  ...
  - q: "¿Qué arreglos corresponden al inquilino y cuáles al propietario?"
    a: "Las reparaciones necesarias para mantener la vivienda habitable —una caldera rota, una fuga, una instalación que falla— corresponden al propietario, sin que pueda subir la renta por hacerlas. El mantenimiento del día a día por uso normal corresponde al inquilino."
  - q: "¿Cuánto tiempo se le da a un inquilino para desocupar la casa?"
    a: "Depende del motivo. Si el contrato termina por vencimiento del plazo pactado o de la prórroga legal, el aviso suele darse con meses de antelación. Si es un desahucio judicial, los plazos los fija el procedimiento, con pasos de intermediación obligatoria si hay situación de vulnerabilidad."
  - q: "¿Cuáles son las tres cláusulas que no deben faltar en un contrato de arrendamiento?"
    a: "Duración y prórroga, importe de la renta y forma de actualización, y cuantía de la fianza. Sin esas tres claras por escrito, cualquier desacuerdo posterior es mucho más difícil de resolver."
  - q: "¿Puede el propietario echarme antes de que acabe el contrato?"
    a: "No, salvo causas legales concretas —como recuperar la vivienda para uso propio o de un familiar directo, avisando con la antelación que marca la ley— o impago por tu parte. Fuera de esos casos, el contrato te protege hasta que termine el plazo pactado."
  - q: "¿Tengo derecho a recuperar la fianza al final del contrato?"
...
- [Duración del contrato y cómo marcharte antes de tiempo](#duración-del-contrato-y-cómo-marcharte-antes-de-tiempo)
- [Reparaciones: qué le toca pagar al propietario y qué a ti](#reparaciones-qué-le-toca-pagar-al-propietario-y-qué-a-ti)
- [Fianza, recibos y otros derechos económicos](#fianza-recibos-y-otros-derechos-económicos)
- [Derecho de tanteo y retracto si el propietario vende](#derecho-de-tanteo-y-retracto-si-el-propietario-vende)
- [Qué hacer si el casero quiere echarte o no respeta tus derechos](#qué-hacer-si-el-casero-quiere-echarte-o-no-respeta-tus-derechos)
...
::img[persona firmando documento legal]
