---
title: "Affordable Housing Near Madrid: The Real Split"
...
faq:
  ...
  - q: "Is it cheaper to live outside Madrid and commute?"
    a: "Usually, yes. Getafe runs about 60% of central Madrid's rent for a 20–25 minute commute; Fuenlabrada and Móstoles run even lower, for a longer ride."
  - q: "How long is the commute from Getafe to Madrid?"
    a: "About 20 to 25 minutes by Cercanías C-4."
  - q: "Is Alcalá de Henares a good place to live?"
    a: "Yes, for people who want a genuinely separate town rather than a Madrid suburb — it has its own university, historic center, and rental market, at about €1,096/month for an 80 m² flat, 35–40 minutes from the center."
  - q: "What's the difference between Madrid's affordable towns and its expensive suburbs?"
    a: "Towns like Fuenlabrada, Móstoles, and Getafe are genuinely cheaper than central Madrid. Suburbs like Pozuelo de Alarcón, Alcobendas, and San Sebastián de los Reyes actually cost more per square meter than some Madrid neighborhoods — they solve a different problem than affordability."
  - q: "Can you commute to Madrid from Toledo?"
    a: "Yes, in about 35 minutes by AVE — though at regular high-speed rail prices, it works better for a few days a week than a daily commute."
  - q: "What towns are connected to Madrid by Cercanías?"
    a: "Fuenlabrada, Móstoles, Alcorcón, and Leganés via the C-5 line; Getafe via C-4; Alcalá de Henares via C-2/C-7 — all also connected to Madrid's Metro network at various points."
  - q: "Is Leganés cheap to live in?"
    a: "It depends on the area. Leganés Norte runs about €6.71/m², among the cheapest in the region, while La Fortuna, a nicer pocket of the same town, runs closer to €15.50/m²."
---

Affordable housing near Madrid exists, but not always where generic suburb lists point you. Fuenlabrada rents for about €13.2 per square meter against Madrid's citywide average of roughly €23 — nearly half. Here's which towns are cheaper because of a real trade-off, and which ones just aren't cheap at all.

## Table of contents

- [Why comparing six towns is harder than comparing six neighborhoods](#why-comparing-six-towns-is-harder-than-comparing-six-neighborhoods)
- [The real affordable belt: Fuenlabrada, Móstoles, Alcorcón, and Leganés](#the-real-affordable-belt-fuenlabrada-mostoles-alcorcon-and-leganes)
- [Getafe: fast and still affordable](#getafe-fast-and-still-affordable)
- [Alcalá de Henares: further out, noticeably cheaper](#alcala-de-henares-further-out-noticeably-cheaper)
- [The AVE option: Toledo, Valladolid, and Zaragoza](#the-ave-option-toledo-valladolid-and-zaragoza)
- [The "suburb" guides that aren't actually about affordability](#the-suburb-guides-that-arent-actually-about-affordability)
...
All four connect to MetroSur as well as Cercanías C-5, so getting between them doesn't mean going back through central Madrid first.

## Getafe: fast and still affordable

Getafe is the fastest option on this list — 20 to 25 minutes to central Madrid via Cercanías C-4. An 80 m² flat runs around €1,120 a month by [Idealista's direct comparison](https://www.idealista.com/en/news/lifestyle-in-spain/2026/03/16/888678-cheaper-alternatives-to-madrid-for-living-5-cities-with-lower-prices-and-solid-links) against Madrid's own €1,864 for the same size — a little over 60% of the capital's rent, for a fraction of the commute time some of the cheaper southern towns require.

Other sources put Getafe's rent per square meter higher, closer to €18–20/m², depending on the neighborhood inside the town. Getafe isn't uniform, and which end you land in changes the math.

## Alcalá de Henares: further out, noticeably cheaper

::img[historic university town]

Alcalá de Henares runs about €1,096 a month for an 80 m² flat, on a 35 to 40 minute Cercanías ride (C-2/C-7). It's also a university town — Cervantes was born here, and nobody will let you forget it — so the rental market includes a large student population, which keeps smaller flats in steady supply.

The trade-off: it's a genuinely different town, not a Madrid neighborhood with a longer commute. Daily life, shops, and social scene happen locally, not in the capital.

## The AVE option: Toledo, Valladolid, and Zaragoza
...
A lot of "Madrid suburbs" content lumps genuinely affordable towns in with places that were never trying to be cheap. Pozuelo de Alarcón (€19.90/m²), Alcobendas (€22.90/m²), and San Sebastián de los Reyes (€20.70/m²) all show up on "best Madrid suburbs" lists — and all of them cost more per square meter than Tetuán or Carabanchel do inside the city itself.

These towns solve a different problem: space, schools, and a garden, for people who could afford central Madrid and chose not to. That's a legitimate reason to move. It's just not the same reason as being priced out.
...
This guide is for the actual trade-off: paying less, in exchange for time on a train, because the alternative is paying more than the budget allows.
