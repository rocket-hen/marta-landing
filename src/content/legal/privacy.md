...
| Marketing emails to existing customers about similar services | Email | Legitimate interests / Art. 21(2) LSSI — opt-out in every message |
...
If you are not satisfied, you may complain to the supervisory authority in the EU country where you live, work, or where the issue arose. If you are in Spain, that is the **Agencia Española de Protección de Datos** (C/ Jorge Juan 6, 28001 Madrid — [www.aepd.es](https://www.aepd.es)).
...
Questions about this policy or how we handle data: [**privacy@callmarta.com**](mailto:privacy@callmarta.com)
